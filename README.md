...
### Workload Simulation
```bash
time ./boilerplate/cpu_hog
time ./boilerplate/memory_hog
```
...
CPU and memory intensive programs used to test system behavior.

### 7. Kernel monitoring
Kernel module prints soft and hard limit events.
...
![Workload](Screenshots/9_workload.png)
...
### Scheduling Behavior
Linux scheduler behavior is demonstrated using different nice values and workload programs.
...
| Scheduling | Nice values + workloads | Limited control | Shows scheduler clearly |
...
This project demonstrates key operating system concepts including process management, container-like execution, scheduling, workload simulation, and kernel-level monitoring in a simplified environment.
